#!/usr/bin/env Rscript
# ==============================================================================
# [Script]: 7.6.1.2_extract_snps_by_gene_region_template.R
# [Method]: cis-MR IV Selection Pipeline Step
# [Step]: 7.6.1.2_extract_snps_by_gene_region.R
# 
# [Function]:
...
log_message(paste("Starting", "7.6.1.2_extract_snps_by_gene_region.R"))
\n",
  "** / Date:** ", Sys.time, "\n\n",
  "##  / Task Description\n",
